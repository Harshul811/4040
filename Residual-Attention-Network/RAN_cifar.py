...
class ResidualAttentionNetwork:
    def __init__(self, input_shape, n_classes, activation='softmax', p=1, t=2, r=1, kernel_size=(3, 3), dropout_rate=0.2):
        """
    ...
    def build_model(self):
        ...
        #Attention Stage 2 (stage 3 from original paper): 2 modules
